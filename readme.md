...
In the same plot, we also show the dominant SM background that gives the similar massdrops. We can see that ttbar contributes similar massdrop spectrum to stop to top, and QCD background is similar in massdrop for stop to bottom. This is because ttbar are boosted in a 100 TeV collider and cotribute to boosted top, and similarly boosted bottom coming from QCD. These SM background has to be filtered by other cuts.
